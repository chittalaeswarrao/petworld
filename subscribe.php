...
<body>
    ...
    <div class="subimg">
      <h1 style="text-align: center;">Subscribe Here </h1>
      <!-- Your HTML form -->
<form action="#" method="POST">
    <!-- Your form fields go here -->
        ...
        Subscription Frequency:
            <label>Weekly</label>
            <input type="radio"  id="weekly" name="frequency" value="weekly"style="transform: scale(1.5);">
            <label>Monthly</label>
            <input type="radio" id="Monthly" name="frequency" value="monthly"style="transform: scale(1.5);">
            <label>Yearly</label>
            <input type="radio" id="Yearly" name="frequency" value="Yearly"style="transform: scale(1.5);">

        </div>
      
        <button type="submit" name="insert" class="submit-button">Subscribe</button>
      </form>
...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO subscribers(Name,Mobile,Gmail) VALUES ('$Name','$Mobile','$Gmail')";
